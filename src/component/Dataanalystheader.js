...
import './dataanalystheader.css'

const Dataanalystheader = () => {
  return (
    <>
         <header className='header-dataanalyst'> 
        ...
        <div className='animation-svg'>
         ...
         <div className='hero-content'>
             ...
             <div className='hero-text'>
                 <h6>Equipping businesses to make
                 </h6>
                 {/* <h3>Sustainable</h3> */}
                 <h2><span className='spanh2'>data-driven decisions</span></h2>
                 <h6>to achieve exponential growth
                 </h6>
             </div>
         </div>
...
export default Dataanalystheader