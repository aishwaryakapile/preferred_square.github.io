...
import './financialadheader.css'
const Financialadheader = () => {
  return (
    
    <>
         <header className='header-financial'> 
        ...
        <div className='animation-svg'>
         ...
         <div className='hero-content'>
             ...
             <div className='hero-text'>
                 <h6>Maximizing business value through
                 </h6>
                 {/* <h3>Sustainable</h3> */}
                 <h2><span className='spanh2'>tailored</span></h2>
                 <h6>investment research solutions 
                 </h6>
             </div>
         </div>
...
export default Financialadheader